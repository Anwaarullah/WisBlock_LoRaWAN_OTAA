...
uint8_t nodeDeviceEUI[8] = {0xAC,0x1F,0x09,0xFF,0xFE,0x01,0x45,0x55};
uint8_t nodeAppEUI[8] = {0xEC,0xFA,0xF4,0xFE,0x00,0x00,0x00,0x01};
uint8_t nodeAppKey[16] = {0x44,0xD9,0x11,0x7B,0x0F,0x2B,0x57,0xD9,0xFB,0xE7,0x3F,0x41,0xAD,0x7C,0x82,0x60};
...
static void lorawan_join_failed_handler(void)
{
  ...
  u8g2.clearBuffer();         // clear the internal memory
  u8g2.setFont(u8g2_font_ncenB10_tr); // choose a suitable font
  u8g2.drawStr(1, 15, "FAILED");
  u8g2.drawStr(1, 30, "RETRY");  
  u8g2.sendBuffer(); // transfer internal memory to the display  
}
